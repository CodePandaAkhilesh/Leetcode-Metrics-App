document.addEventListener("DOMContentLoaded", function() {
    ...
    // function batayega entered username valid hai ya nahi
    function validateUsername(username) {
        if (username.trim() === "") { // username.trim() removes the extra spaces before and after "  JohnDoe ", leaving just "JohnDoe".
    ...
    function displayUserData(parsedData) {
        // Directly access properties from the parsedData
        ...
        // Populate the card stats container
